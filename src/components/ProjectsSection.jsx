      ...
      >
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 sm:gap-y-10 md:gap-y-20 lg:gap-y-20">
          {projects.map((project, index) => (
            <div key={index}>
              <div className="sm:gap-2 md:gap-5 lg:gap-5 flex-grow-0 flex-shrink-0 flex-col bg-accent sm:h-[15rem] sm:w-[18rem] md:h-[20rem] md:w-[25rem] lg:h-[20rem] lg:w-[25rem] rounded-2xl relative before:absolute before:sm:h-[15rem] before:sm:w-[18rem] before:md:h-[20rem] before:md:w-[25rem] before:lg:h-[20rem] before:lg:w-[25rem] before:rounded-2xl before:bg-secondary before:top-2 before:left-3 before:-z-10 flex justify-center items-left">
